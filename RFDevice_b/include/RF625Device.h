...
namespace RFDevice {
	...
	public:
		...
		static const size_t ProfileBufferSize = (12 + 1280*8 + 2 + 512);
		...
		//-----------------------------------------------------------------------------
		USHORT ConvertResultToPoints(void IN *lpResultBuffer, float OUT *lpPointsBuffer, USHORT OUT *lpCount, BOOL bChecksumCheck = FALSE);
